...
#DATA_PATH_V1 = "/groups/gaa50131/datasets/sunrgbd1/sunrgbd_pc_bbox_votes_50k_v1" ## Replace with path to dataset
...
class SunrgbdDetectionDataset(Dataset):
    def __init__(
        ...
        self.use_v1 = use_v1
        self.DATA_PATH_V1 = DATA_PATH_V1 + '/sunrgbd_pc_bbox_votes_50k_v1'

        if root_dir is None:
            root_dir = self.DATA_PATH_V1 if use_v1 else DATA_PATH_V2
