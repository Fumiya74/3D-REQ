...
def make_args_parser():
    ...
    parser.add_argument("--loss_sem_cls_weight", default=0.8, type=float)
    #parser.add_argument("--loss_obj_sem_cls_weight", default=0.5, type=float) ##TODO## 
    parser.add_argument("--loss_caption_weight", default=0.5, type=float) ##TODO##
    parser.add_argument(
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", required=True, type=str, choices=["scannet", "sunrgbd", "ecc", "ecc1"]
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
    ...
    parser.add_argument("--dataset_num_workers", default=128, type=int)
    ...
    parser.add_argument("--save_separate_checkpoint_every_epoch", default=20, type=int)
