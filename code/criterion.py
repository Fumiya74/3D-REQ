...
class Matcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        #print(self.cost_class * class_mat)
        #print('222222222222222222222222222')
        #print(self.cost_objectness * objectness_mat)    
        #print('333333333333333333333333333')
        #print(self.cost_center * center_mat)            
        #print('444444444444444444444444444')
        #print(self.cost_giou * giou_mat)          
...
class SetCriterion(nn.Module):
    def __init__(self, matcher, dataset_config, loss_weight_dict):
        ...
        self.loss_caption_criterion = nn.CrossEntropyLoss()
        ...
        self.loss_functions = {
            ...
            #"loss_obj_sem_cls": self.loss_obj_sem_cls,##TODO##
            "loss_caption": self.loss_caption,##TODO##
    ...
    def loss_caption(self, outputs, targets_, assignments):
        ###
        scores = outputs["predict_captions"]
        ...
        loss = self.loss_caption_criterion(scores, targets)
    ...
    def single_output_forward(self, outputs, targets):
        ...
        outputs["gious"] = gious
        temp = torch.tensor(targets["gt_box_centers_normalized"],dtype=torch.float32).cuda()
        temp1 = torch.tensor(outputs["center_normalized"],dtype=torch.float32).cuda()
...
def build_criterion(args, dataset_config):
    ...
    loss_weight_dict = {
        ...
        #"loss_obj_sem_cls_weight": args.loss_obj_sem_cls_weight,##TODO##
        "loss_caption_weight": args.loss_caption_weight,##TODO##
