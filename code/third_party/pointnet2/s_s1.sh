...
#$ -cwd
#$ -N setup
#$ -o /groups/gab50221/user/qiuyue/change_captioning/3drepresentation/3detr_testgpu/third_party/pointnet2
...
cd /groups/gab50221/user/qiuyue/change_captioning/3drepresentation/3detr_testgpu/third_party/pointnet2
