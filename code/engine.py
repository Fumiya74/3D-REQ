...
def train_one_epoch(
    ...
    for batch_idx, batch_data_label in enumerate(dataset_loader):
        #if ((curr_iter > 180) and (curr_iter < 190)) or ((curr_iter > 1700 )and(curr_iter < 1800)):
        #  continue
        curr_time = time.time()
        ...
        inputs = {
            ...
            "gt_captions": batch_data_label["gt_captions"],
            "gt_caption_lens": batch_data_label["gt_caption_lens"],         
            "res": batch_data_label["res"],
            "re_lens": batch_data_label["re_lens"],
        }
        
        outputs = model(inputs)
        #print(batch_data_label["scan_idx1"])
        # Compute loss
