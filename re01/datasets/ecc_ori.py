...
class ECCDatasetConfig(object):
    def __init__(self):
        ...
        self.num_semcls = 8  ####
        self.num_objsemcls = 21 ##TODO##
        self.num_angle_bin = 12   ####
        self.max_num_obj = 8  ####################TODO######################
        self.type2class = {  ####################TODO######################
            "add": 0,
            "delete": 1,
            "open_b": 2,
            "open_a": 3,
...
class ECCDetectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        bboxes = (np.load(scan_path + "_bbox.npy")[:,0:8])  # K,8
        bboxes_1 = (np.load(scan_path + "_bbox.npy")[:,0:3])  # K,8
        obj_classes = (np.load(scan_path + "_bbox.npy")[:,8:9])  # K,1 ###----- Object Classes ----###TODO###
        ...
        max_bboxes[0 : bboxes.shape[0], :] = bboxes[:,0:8]  ########################### 
